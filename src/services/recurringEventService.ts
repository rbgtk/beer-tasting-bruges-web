...
export async function createRecurringEvent(recurringEvent: RecurringEvent): Promise<RecurringEvent> {
...
export async function updateRecurringEvent(recurringEvent: RecurringEvent): Promise<RecurringEvent> {
  const response = await api.put(`/api/events/recurring/${recurringEvent.id}`, recurringEvent);
  return response.data;
}

export async function deleteRecurringEvent(recurringEvent: RecurringEvent): Promise<void> {
